...
export default class VendorSearch extends Component {
    ...
    onSubmit = e => {
        ...
        var instance = axiosInstance.get(`/vendors/?search_string=${this.state.search_string}`)
    ...
    selectVendor(e) {
        ...
        var vendor = this.state.vendors.find(obj => obj.id == e.target.getAttribute('data-item'))
        console.log(vendor)
        ...
        return (
            <Col>
                <form className="form-horizontal" onSubmit={this.onSubmit}>
                    <FormGroup row>
                        ...
                        <div className="col-xl-12 input-group">
                            <Input type="name" name='search_string' placeholder="Search for Vendor by number,  name, email and phone number" onChange={this.onChange} value={this.state.search_string} readOnly={this.state.readonly} />
                ...
                <table className="table table-striped my-4 w-100 table-bordered">
                    ...
                    <tbody>
                        {this.state.vendors.map((row, i) => {
                            return (<tr data-item={row.id} onClick={this.selectVendor.bind(this)} key={i + 1} vendor={row}>
