...
class Login extends Component {
    ...
    render() {
        return (
            <AuthLayout>
                {this.state.show_confirmed ? this.showConfirmed()  :<div className='col-md-4 col-sm-4 authDiv'>
                
                 <div className='col-md-12 header'><h2>User Login</h2>
                        ...
                        <UserLoginForm id='loginBox' {...this.state} loading={this.props.authentication.loading} onChange={this.onChange} login={this.login} /> 
