            ...
            <Form id={this.props.id} className='col-md-12' onSubmit={this.props.login}>
                ...
                <Row>
                    ...
                    <Col md={8} className="resetPassword">
                        <p>Forgot your password? <Link to='/forgot_password'>Reset Password</Link></p>
                    </Col>
                </Row>
                <Row>
                    <Col md={12} className="signup">
                        <p>Don't have an account? <Link to='/sign_up'>Sign up</Link> or  <Link to='/confirm_email'>Confirm Your Email</Link></p>
                    </Col>
