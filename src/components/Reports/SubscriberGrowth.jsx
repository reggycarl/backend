...
class SubscriberGrowths extends Component {
  state = {
    data: {},
    loading: false,
  ...
  populate = () => {
    axiosInstance
      .get(
        `/admins/reports/subscriber_growth?start_date=${this.state.start_date.format(
          "YYYY-MM-DD"
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(SubscriberGrowths)
);
