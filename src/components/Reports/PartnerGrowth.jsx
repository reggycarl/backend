...
class PartnerGrowths extends Component {
  state = {
    data: {},
    loading: false,
  ...
  populate = () => {
    axiosInstance
      .get(
        `/admins/reports/partner_growth?start_date=${this.state.start_date.format(
          "YYYY-MM-DD"
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(PartnerGrowths)
);
