...
class SalesPerVendor extends Component {
  state = {
    data: {},
  ...
  populate = () => {
    axiosInstance
      .get(
        `/admins/reports/sales_per_vendor?start_date=${this.state.start_date.format(
          "YYYY-MM-DD"
      ...
      <Col md={12}>
        <Card>
          <CardBody>
            ...
            />
            <CardTitle>Sales Per Vendor</CardTitle>
            <CardText>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(SalesPerVendor)
);
